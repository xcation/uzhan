...
<div class="admin_wrap">
        ...
        <div class="admin_content">
            <div class="admin_breadLine">
                ...
                <div class="insert-btn"><a href="/index.php?g=Admin&m=business&a=insertbusiness" class="buttonS bGreen">新增商家</a></div>
            </div>
            <div class="Data_Sheet">
               <div class="widget">
                    <div class="whead"><h6>新增商家信息</h6><div class="clear"></div></div>
                        ...
                        <div class="info_main">
                            ...
                            <dl>
                                ...
                                <dd class="pt7">
                                    ...
                                    <span class="red">店名只能通过淘字号修改</span>
                                </dd>
                            </dl>
                            <dl>
                                <dt>店铺地址：</dt>
                            ...
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        ...
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传图标" id="business_logo" />
                                        <span class="info-tip"><span class="red">★</span> 文件格式GIF、JPG、JPEG、PNG文件大小80K以内，建议尺寸80PX*80PX</span>
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        ...
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传声频" id="business_voice" />
                                        <span class="info-tip">
                                            <span class="red">★</span> 文件格式SWF、WAV、MP3、WMA文件大小200K以内，建议使用SWF格式
                                        </span>
                                    </div>
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        <img src="/assets/images/shop_logo.jpg" class="shop-pic" width="80" height="80">
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传图片" id="business_imgs" />
                                        <span class="info-tip"><span class="red">★</span> 文件格式JPG、JPEG，尺寸210PX*290PX</span>
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        <img src="/assets/images/shop_logo.jpg" class="shop-pic" width="80" height="80">
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传图片" id="business_imgb" />
                                        <span class="info-tip"><span class="red">★</span> 文件格式JPG、JPEG，尺寸375PX*295PX</span>
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        <img src="/assets/images/shop_logo.jpg" class="shop-pic" width="80" height="80">
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传图片" id="business_img1" />
                                        <span class="info-tip"><span class="red">★</span> 文件格式JPG、JPEG，尺寸300PX*235PX</span>
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        <img src="/assets/images/shop_logo.jpg" class="shop-pic" width="80" height="80">
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传图片" id="business_img2" />
                                        <span class="info-tip"><span class="red">★</span> 文件格式JPG、JPEG，尺寸300PX*235PX</span>
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd class="pt7">
                                    <div class="shop-photo">
                                        <img src="/assets/images/shop_logo.jpg" class="shop-pic" width="80" height="80">
                                        <input type="submit" class="bGreen cof shop-photo-button" value="上传图片" id="business_img3" />
                                        <span class="info-tip"><span class="red">★</span> 文件格式JPG、JPEG，尺寸300PX*235PX</span>
                                    </div>
                                </dd>
                            </dl>
                   ...
                   <div class="input-button1"><input type="submit" class="buttonS bBlue" value="提交"/></div>
               </div>
