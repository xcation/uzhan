...
<div class="content">
   <div class="breadLine">
    ...
    <div class="wrapper">
        <form method="post" action="/index.php?g=Admin&m=Tip&a=updates" >
            <ul class="admin-content">
                <li ><a>小报的标题：</a><input type="text" class="inputfield" name="tip_title" value="{$list.tip_title}"/></li>
                <div class="divider"><span></span></div>
                <li><a>小报的地址：</a><input type="text" class="inputfield"  name="tip_url" value="{$list.tip_url}"/></li>
                <div class="divider"><span></span></div>
                <li ><a>小报商家id：</a><input type="text" class="inputfield"  name="tip_business_id" value="{$list.tip_business_id}"/></li>
                <div class="divider"><span></span></div>
                <li><a>小报自己id：</a><input type="text" class="inputfield" name="tip_id" value="{$list.tip_id}"/></li>
                <div class="divider"><span></span></div>
