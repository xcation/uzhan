...
<div class="admin_wrap">
		...
		<div class="admin_sidebar fl">
			<div class="admin_subNav">
				...
				<ul class="admin_subNav_menu">
                	...
                	<li><a href="/index.php?g=Admin&m=tip" title="" class="this"><span class="icos-transfer"></span>管理文章</a></li>
				</ul>
				<div class="divider"><span></span></div>
		...
		<div class="admin_content">
           ...
           <div class="pageinfo">
            <p>总共有{$count}条记录 第{$currentpage}:{$maxpage}页
            <a href="/index.php?g=admin&m=tip&p=1">&lt&lt</a>
            <a href="/index.php?g=admin&m=tip&p={$prepage}">前一页</a>
            <a href="/index.php?g=admin&m=tip&p={$prepage}">{$prepage}</a>
            <a>{$currentpage}</a>
            <a href="/index.php?g=admin&m=tip&p={$nextpage}">{$nextpage}</a>
            <a href="/index.php?g=admin&m=tip&p={$nextpage}">后一页</a>
            <a href="/index.php?g=admin&m=tip&p={$maxpage}">&gt&gt</a>
            </p>
        <div>
