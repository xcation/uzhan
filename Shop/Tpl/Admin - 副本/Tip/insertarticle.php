   ...
   <div class="breadLine">
    ...
    <div class="wrapper">
            <ul class="admin-content">
                <li ><a>小报的标题：</a><input type="text" class="tip_title inputfield"/></li>
                <div class="divider"><span></span></div>
                <li><a>小报的地址：</a><input type="text" class="inputfield tip_url"/></li>
                <div class="divider"><span></span></div>
                <li ><a>小报商家id：</a><input type="text" class="inputfield tip_businessid"/></li>
                <div class="divider"><span></span></div>
                <li>
              
                <div class="divider"><span></span></div>
                <li>
                <button type="submit" class="buttonS bGreen save-btn tip_add_button">提交</button>
                </li>
            </ul>
        <div class="divider"><span></span></div>
    </div>
